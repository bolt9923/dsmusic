...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+AXtqhgjirVNjNTk1")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/+5ChO5TKoms9lYzQ1")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/1i9pr6.jpg"
)
PING_IMG_URL = getenv(
