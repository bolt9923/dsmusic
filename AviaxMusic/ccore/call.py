...
import config
from AviaxMusic import LOGGER, YouTube
...
from AviaxMusic.utils.inline.play import stream_markup, telegram_markup
    ...
    async def change_stream(self, client, chat_id):
        ...
        try:
            ...
            if "live_" in queued:
                ...
                mystic = await client.send_message(original_chat_id, _["call_7"])
                try:
